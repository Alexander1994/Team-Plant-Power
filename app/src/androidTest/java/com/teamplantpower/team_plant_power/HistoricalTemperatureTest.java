...
public class HistoricalTemperatureTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void historicalTemperatureTest() {
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.historicalTemperature), isDisplayed()));
        ...
        ViewInteraction listView = onView(
                allOf(withId(R.id.temperatureList),
                        childAtPosition(
                                childAtPosition(
